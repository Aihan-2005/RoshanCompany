...
function Archive() {
  ...
  const archiveItems = useSelector((state) => state.archive.items);
  ...
  useEffect(() => {
    ...
    dispatch(setArchiveItems(data));
  }, [dispatch]);

  const handleDelete = (id) => {
    dispatch(deleteArchiveItem(id));
                ...
                >
                  <div className="grid grid-cols-14 items-center gap-4 pr-[0px] py-2" style={{ minHeight: "40px" }}>
                    ...
                    <div className="flex justify-start gap-1 col-span-3 pl-[100px]">
                      ...
                      >
                        <img src={del_Btn} alt="del" className="w-[9px] h-[14px]" />
                      </button>
                      <button
                        onClick={() => {
                      ...
                      >
                        <img src={copy_Icon} alt="copy" className="w-[16px] h-[17px] absolute opacity-100 group-hover:opacity-0" />
                        <img src={copy_IconG} alt="copy-hover" className="w-[16px] h-[17px] absolute opacity-0 group-hover:opacity-100" />
                      </button>
                      <button
                        onClick={() => {
                      ...
                      >
                        <img src={Word_icon} alt="Word" className="w-[13px] h-[16px]" />
                      </button>
                      <button
                        onClick={() => {
                          const a = document.createElement("a");
                        ...
                        className="group w-[30px] h-[30px] relative flex items-center justify-center"
                      >
                        <img src={download_Icon} alt="download" className="w-[13.5px] h-[14.5px] absolute opacity-100 group-hover:opacity-0" />
                        <img src={download_IconG} alt="download-hover" className="w-[13.5px] h-[14.5px] absolute opacity-0 group-hover:opacity-100" />
                      </button>
                    </div>
